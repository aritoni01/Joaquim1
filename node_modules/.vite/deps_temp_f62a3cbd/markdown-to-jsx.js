...
function Qe(r2 = "", t2 = {}) {
  ...
  const s2 = t2.slugify || Ee, V2 = t2.sanitizer || we, H2 = t2.createElement || e.createElement, Q2 = [f, h, g, t2.enforceAtxHeadings ? E : z, R, D, ke, xe], W2 = [...Q2, F, A, L, j];
  function J2(e2, r3, ...o2) {
    const a2 = He(t2.overrides, e2 + ".props", {});
    return H2(function(e3, n2) {
      const r4 = He(n2, e3);
      return r4 ? "function" == typeof r4 || "object" == typeof r4 && "render" in r4 ? r4 : He(n2, e3 + ".component", e3) : e3;
    }(e2, t2.overrides), n({}, r3, a2, { className: Ve(null == r3 ? void 0 : r3.className, a2.className) || void 0 }), ...o2);
  }
  function re2(e2) {
    e2 = e2.replace(S, "");
    let n2 = false;
    ...
    return r3 ? r3.reduce(function(n3, r4) {
      ...
      if (-1 !== t3) {
        ...
        const l2 = n3[u2] = function(e3, n4, r5, t4) {
          ...
          }, {}) : -1 !== i.indexOf(n4) ? t4(De(r5), e3, n4) : (r5.match(C) && (r5 = De(r5.slice(1, r5.length - 1))), "true" === r5 || "false" !== r5 && r5);
        }(e2, a2, c2, V2);
  ...
  const ie2 = [], ue2 = {}, le2 = { 0: { t: [">"], o: Ie(f), i: 1, u(e2, n2, r3) {
    ...
    const t3 = { key: r3.key };
    return e2.alert && (t3.className = "markdown-alert-" + s2(e2.alert.toLowerCase(), Ee), e2.children.unshift({ attrs: {}, children: [{ type: "27", text: e2.alert }], noInnerParse: true, type: "11", tag: "header" })), J2("blockquote", t3, n2(e2.children, r3));
  } }, 1: { o: Te(p), i: 1, u: Ge, l: (e2, n2, r3) => J2("br", { key: r3.key }) }, 2: { t: (e2) => {
    const n2 = e2[0];
    return "-" === n2 || "*" === n2 || "_" === n2;
  }, o: Ie(y), i: 1, u: Ge, l: (e2, n2, r3) => J2("hr", { key: r3.key }) }, 3: { t: ["    "], o: Ie(g), i: 0, u: (e2) => ({ lang: void 0, text: De(Se(e2[0].replace(/^ {4}/gm, ""))) }), l: (e2, r3, t3) => J2("pre", { key: t3.key }, J2("code", n({}, e2.attrs, { className: e2.lang ? "lang-" + e2.lang : "" }), e2.text)) }, 4: { t: ["```", "~~~"], o: Ie(h), i: 0, u: (e2) => ({ attrs: ce2("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }) }, 5: { t: ["`"], o: Ce(m), i: 3, u: (e2) => ({ text: De(e2[2]) }), l: (e2, n2, r3) => J2("code", { key: r3.key }, e2.text) }, 6: { t: ["[^"], o: Ie(v), i: 0, u: (e2) => (ie2.push({ footnote: e2[2], identifier: e2[1] }), {}), l: Ue }, 7: { t: ["[^"], o: je(q), i: 1, u: (e2) => ({ target: "#" + s2(e2[1], Ee), text: e2[1] }), l: (e2, n2, r3) => J2("a", { key: r3.key, href: V2(e2.target, "a", "href") }, J2("sup", { key: r3.key }, e2.text)) }, 8: { t: ["[ ]", "[x]"], o: je($), i: 1, u: (e2) => ({ completed: "x" === e2[1].toLowerCase() }), l: (e2, n2, r3) => J2("input", { checked: e2.completed, key: r3.key, readOnly: true, type: "checkbox" }) }, 9: { t: ["#"], o: Ie(t2.enforceAtxHeadings ? E : z), i: 1, u: (e2, n2, r3) => ({ children: Fe(n2, e2[2], r3), id: s2(e2[2], Ee), level: e2[1].length }), l: (e2, n2, r3) => J2("h" + e2.level, { id: e2.id, key: r3.key }, n2(e2.children, r3)) }, 10: { o: Ie(R), i: 0, u: (e2, n2, r3) => ({ children: Fe(n2, e2[1], r3), level: "=" === e2[2] ? 1 : 2, type: "9" }) }, 11: { t: ["<"], o: Te(A), i: 1, u(e2, n2, r3) {
    const [, t3] = e2[3].match(ae), o2 = RegExp("^" + t3, "gm"), a2 = e2[3].replace(o2, ""), i2 = (u2 = a2, W2.some((e3) => e3.test(u2)) ? Ne : Fe);
    var u2;
  ...
  }, l: (e2, r3, t3) => J2(e2.tag, n({ key: t3.key }, e2.attrs), e2.text || (e2.children ? r3(e2.children, t3) : "")) }, 13: { t: ["<"], o: Te(j), i: 1, u(e2) {
    const n2 = e2[1].trim();
    return { attrs: ce2(n2, e2[2] || ""), tag: n2 };
  }, l: (e2, r3, t3) => J2(e2.tag, n({}, e2.attrs, { key: t3.key })) }, 12: { t: ["<!--"], o: Te(L), i: 1, u: () => ({}), l: Ue }, 14: { t: ["!["], o: Ce(be), i: 1, u: (e2) => ({ alt: De(e2[1]), target: De(e2[2]), title: De(e2[3]) }), l: (e2, n2, r3) => J2("img", { key: r3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: V2(e2.target, "img", "src") }) }, 15: { t: ["["], o: je(qe), i: 3, u: (e2, n2, r3) => ({ children: Pe(n2, e2[1], r3), target: De(e2[2]), title: De(e2[3]) }), l: (e2, n2, r3) => J2("a", { key: r3.key, href: V2(e2.target, "a", "href"), title: e2.title }, n2(e2.children, r3)) }, 16: { t: ["<"], o: je(M), i: 0, u: (e2) => ({ children: [{ text: e2[1], type: "27" }], target: e2[1], type: "15" }) }, 17: { t: (e2, n2) => !n2.inAnchor && !t2.disableAutoLink && ($e(e2, "http://") || $e(e2, "https://")), o: je(I), i: 0, u: (e2) => ({ children: [{ text: e2[1], type: "27" }], target: e2[1], title: void 0, type: "15" }) }, 18: { t: ["<"], o: je(T), i: 0, u(e2) {
    let n2 = e2[1], r3 = e2[1];
    ...
    return J2("table", { key: r3.key }, J2("thead", null, J2("tr", null, t3.header.map(function(e3, o2) {
      return J2("th", { key: o2, style: Le(t3, o2) }, n2(e3, r3));
    }))), J2("tbody", null, t3.cells.map(function(e3, o2) {
      return J2("tr", { key: o2 }, e3.map(function(e4, o3) {
        return J2("td", { key: o3, style: Le(t3, o3) }, n2(e4, r3));
      }));
    })));
  } }, 27: { o: Te(te), i: 4, u(e2) {
    const n2 = e2[0];
...
var index_modern_default = (n2) => {
  ...
  return e.cloneElement(Qe(t2, o2), a2);
};
export {
  t as RuleType,
  Qe as compiler,
